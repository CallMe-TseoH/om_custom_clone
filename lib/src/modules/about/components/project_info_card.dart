          ...
          child: Column(
            ...
            children: [
              ...
              ExtendedContainer(
                ...
                child: Image.asset(AssetsHelper.logoOrangeMoney),
              ),
              const Separator(value: 15),
              TextComponent(textKey: "Orange Money Custom Clone", useOverFlow: false, fontWeight: FontWeight.bold, fontSize: SizesHelper.fontSize(17),),
